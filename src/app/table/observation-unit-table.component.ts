...
@Component({
  selector: 'app-observation-unit-table',
  templateUrl: './observation-unit-table.component.html',
  styleUrls: ['./observation-unit-table.component.css']
})
export class ObservationUnitTableComponent implements OnInit {
  dataTable: any;
  dtOptions: any;
  tableData = [];
  @Input() data:{};
