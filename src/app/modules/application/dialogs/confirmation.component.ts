...
export class ConfirmationComponent implements OnInit {
  mode_text = { 
    'removesample': { 'title': "Confirm remove", 'content': " Are you sure to delete associated samples? " },
    'unlinkbm': { 'title': "Confirm remove", 'content': " Are you sure to unlink this biological material and all associated observation units, samples and observations? " },
    'removeobs_unit': { 'title': "Confirm remove", 'content': " Are you sure to delete this observation unit and all samples and observations? " },
    'remove': { 'title': "Confirm remove", 'content': " Are you sure to delete ? " },
    'unsaved_changes': { 'title': "Confirm cancel", 'content': " Are you sure to cancel ? You have unsaved changes " }, 
    'link_study': { 'title': "Confirm change column definition", 'content': " Do you want to link this column with existing study ? " }, 
    'change_field': { 'title': "Confirm change column definition", 'content': " Are you sure to reset this column and all the components associated ? " }, 
    'remove_brief': { 'title': "Confirm remove", 'content': " Are you sure to delete ? " }, 
    'extract_env_var': { 'title': "Confirm extraction", 'content': " Are you sure to extract data? " }, 
    'extract_existing_env_var':{'title': "Confirm new extraction", 'content': " Are you sure to link with this exisitng observed variable ?"}, 
    'extract_env_var_again': { 'title': "Confirm unlink component", 'content': " Are you sure to unlink this component ? This will unlink corresponding components"}
  }
  validated: boolean;
