...
export class OntologyDescriptionComponent implements OnInit {
  ...
  onSelect(values:string) {
        console.log(values)
        const dialogRef = this.dialog.open(OntologyTreeComponent, { width: '1000px', autoFocus: false, maxHeight: '90vh', data: { ontology_id: values, selected_term: null, selected_key:"", selected_set: [], multiple: false, uncheckable: true, observed: true, mode_simplified:true } });
