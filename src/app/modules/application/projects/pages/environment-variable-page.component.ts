...
@Component({
  selector: 'app-environment-variable-page',
  templateUrl: './environment-variable-page.component.html',
  styleUrls: ['./environment-variable-page.component.css']
})
export class EnvironmentVariablePageComponent implements OnInit {
