...
@Component({
  selector: 'app-csv-loader-dialog',
  templateUrl: './csv-loader-dialog.component.html',
  styleUrls: ['./csv-loader-dialog.component.css']
})
export class CsvLoaderDialogComponent implements OnInit {
  ...
  constructor(private alertService: AlertService,private formBuilder: FormBuilder,
    public dialogRef: MatDialogRef<CsvLoaderDialogComponent>,
  ...
  onExtractField(value: string, key: string){
    ...
    console.log(this.get_extracted_field(key))
  }
  get_headers(){
    return this.headers
  }
  get_extracted_field(key: string){
